...
class InitCommandTest extends TestCase
{
    ...
    public function testRunWithAdminAndWithoutReadmeCreation()
    {
        ...
        $this->mockNativeFunction(
            ...
            $this->callFilePutContent('database/migrations/2018_11_11_111111_roles_create_table.php', $this->getFixture('roles_create_table_migration.php')),
            $this->callFilePutContent('database/migrations/2018_11_11_111112_users_add_role_id.php', $this->getFixture('users_add_role_id_migration.php')),
    ...
    public function testRunWithAdminAndDefaultReadmeCreation()
    {
        ...
        $this->mockNativeFunction(
            ...
            $this->callFilePutContent('database/migrations/2018_11_11_111112_admins_create_table.php', $this->getFixture('admins_table_migration.php')),
            $this->callFilePutContent('database/migrations/2018_11_11_111113_add_default_admin.php', $this->getFixture('admins_add_default_admin.php')),
            $this->callGlob(base_path('database/migrations/*_admins_create_table.php'), [base_path('database/migrations/2018_11_11_111112_admins_create_table.php')]),
            $this->callFilePutContent('database/migrations/2018_11_11_111114_add_nova_admin.php', $this->getFixture('admins_add_nova_admin_migration.php')),
            $this->callFilePutContent('renovate.json', $this->getFixture('renovate.json')),
            $this->callFilePutContent(base_path('composer.json'), $this->getFixture('composer_with_pint_settings.json')),
            $this->callFilePutContent(base_path('/routes/web.php'), "\nAuth::routes();\n", FILE_APPEND),
    ...
    public function testRunWithAdminAndFullReadmeCreationAndRemovingInitializatorInstallationMedia()
    {
        ...
        $this->mockNativeFunction(
            ...
            $this->callFilePutContent('database/migrations/2018_11_11_111111_roles_create_table.php', $this->getFixture('roles_create_table_migration.php')),
            $this->callFilePutContent('database/migrations/2018_11_11_111112_users_add_role_id.php', $this->getFixture('users_add_role_id_migration.php')),
            $this->callGlob(base_path('database/migrations/*_roles_create_table.php'), [base_path('database/migrations/2018_11_11_111111_roles_create_table.php')]),
            $this->callFilePutContent('database/migrations/2018_11_11_111113_add_default_admin.php', $this->getFixture('migration.php')),
    ...
    public function testRunWithClerkAdditionalAdminsWithoutDefaultAdmin(): void
    {
        ...
        $this->mockNativeFunction(
            ...
            $this->callFilePutContent('database/migrations/2018_11_11_111112_admins_create_table.php', $this->getFixture('admins_table_migration.php')),
            $this->callFilePutContent('database/migrations/2018_11_11_111113_add_telescope_admin.php', $this->getFixture('admins_add_telescope_admin_migration.php')),
            $this->callGlob(base_path('database/migrations/*_admins_create_table.php'), [base_path('database/migrations/2018_11_11_111112_admins_create_table.php')]),
            $this->callFilePutContent('database/migrations/2018_11_11_111114_add_nova_admin.php', $this->getFixture('admins_add_nova_admin_migration.php')),
            $this->callFilePutContent(base_path('composer.json'), $this->getFixture('composer_with_pint_settings.json')),
            $this->callFilePutContent(base_path('/routes/web.php'), "\nAuth::routes();\n", FILE_APPEND),
