...
class InitCommand extends Command implements Isolatable
{
    ...
    protected function addGcsDiskToConfig(): void
    {
        ...
        $config
            ...
            ->set('disks.gcs.project_id', "env('GOOGLE_CLOUD_PROJECT_ID', 'your-project-id')")
            ->set('disks.gcs.bucket', "env('GOOGLE_CLOUD_STORAGE_BUCKET', 'your-bucket')")
            ->set('disks.gcs.path_prefix', "env('GOOGLE_CLOUD_STORAGE_PATH_PREFIX', '')")
            ->set('disks.gcs.storage_api_uri', "env('GOOGLE_CLOUD_STORAGE_API_URI', null)")
            ->set('disks.gcs.api_endpoint', "env('GOOGLE_CLOUD_STORAGE_API_ENDPOINT', null)")
